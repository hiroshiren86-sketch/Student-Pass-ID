...
**Pendiente del propietario:** decidir P4 (píldora de rol: ¿quitarla o quitar "Cambiar Rol" del menú de sesión?); probar la campanita en sus teléfonos (el audio necesita un toque en la app para desbloquearse — cualquier navegación cuenta); activar el banner de notificaciones por dispositivo si quiere push físico (opcional: campanita + punto rojo ya cubren el flujo sin permisos).
